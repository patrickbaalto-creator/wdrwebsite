...
export function MobileCtaBar() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-white border-t border-gray-200 shadow-lg p-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] flex gap-3">
